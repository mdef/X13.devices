...
#define portCOMPARE_VALUE ((configCPU_CLOCK_HZ/portCLOCK_PRESCALER/configTICK_RATE_HZ)-1)
#if (portCOMPARE_VALUE > 255) || (portCOMPARE_VALUE < 60)
#error Check configCPU_CLOCK_HZ, configTICK_RATE_HZ and portCLOCK_PRESCALER
#endif
